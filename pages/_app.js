      ...
      <div className={homeStyles.container}>
        <main>
          <div className={homeStyles.card}>
            ...
            <Link
              href={`https://www.strava.com/oauth/authorize?client_id=97178&redirect_uri=http://localhost:3000&response_type=code&scope=read,activity:read_all,profile:read_all`}
            >
